...
namespace ASTAX_5
{
    public partial class Search_c_table_form : Form
    {
        ...
        public Search_c_table_form(List<Price> ioList)
        {
            InitializeComponent();
            list = ioList;
        }
        ...
        private void Search_c_table_form_Load(object sender, EventArgs e)
        {
